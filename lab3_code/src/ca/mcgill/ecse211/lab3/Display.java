...
public class Display extends Thread {
  ...
  public void run() {
    ...
    do {
      ...
      LCD.drawString("X: " + numberFormat.format(odometer.getX()), 0, 0);
      LCD.drawString("Y: " + numberFormat.format(odometer.getY()), 0, 1);
      LCD.drawString("T: " + numberFormat.format(odometer.getTheta()), 0, 2);
